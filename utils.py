...
def download_file(url: str, output_path: str):
    """
    Descarga con verificación SSL; si falla, reintenta sin verificar (workaround para TUM).
    """
    try:
...
def extract(archive_path: str, dest: str = "."):
    """
    Extrae .tgz/.tar.gz o .zip según extensión.
    """
    ...
    if lower.endswith((".tgz", ".tar.gz")):
        ...
        raise ValueError(f"Formato no soportado para extraer: {archive_path}")
